...
#include "filtr_coeff.h"
#include "adc.h"


#define CHAN_NUM  7
#define WVFRM_LENG   1024
...
//  ADC0->CONFIG1 = (255<<12)|(511<<3);  //вот такая хренотень
  ADC0->CONFIG1 = (8<<12)|(12<<3);  //вот такая хренотень
//  ADC0->CONFIG1 = (5<<12)|(5<<3);  //вот такая хренотень
  /* калибровка */
...
uint32_t ChList;
uint8_t FillListFlg = 0;

uint32_t XYState[10][3][7];
